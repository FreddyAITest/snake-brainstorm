...
**Model Options:**
  - Default: ollama/qwen3.5:cloud (fast, local)
  - Complex: gemini-2.5-flash (use `gemini` CLI, `GOOGLE_API_KEY` configured ✅)
  - Use Gemini for: complex logic, multi-file refactors, API integrations, Python/JS generation
